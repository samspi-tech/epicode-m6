...
blogPosts.post('/blogPosts/create', validation('createBlogPost'), blogPostsController.createBlogPost);
blogPosts.patch('/blogPosts/update/:id', validation('updateBlogPost'), blogPostsController.updateBlogPost);
